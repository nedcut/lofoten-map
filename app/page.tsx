...
export default function Home() {
  ...
  return (
    <main className="relative h-dvh overflow-hidden bg-[#e7efe8] text-stone-950">
      ...
      {panel === "photo" ? <UploadPhotoPanel days={data.days} routes={data.routeSegments} tripSlug={tripSlug} defaultDayId={selectedDayId} pendingCoordinate={pendingCoordinate} isSaving={saving} onCancel={closePanel} onCoordinatePreview={setPendingCoordinate} onSave={savePhotos} /> : null}
